...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 40.0, 443.0, 74.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "h-strek.pct",
				"bootpath" : "/Users/renstemming/groven/release våren 2014/Graphics/Quickdraw-pct (any alpha-ch won't work)",
